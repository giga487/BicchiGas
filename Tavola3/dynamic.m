...
dq(1) = q(2);
dq(2) = ((-b1*q(2))/D + ((b2*q(4) - gravity*l*sin(q(1))*B) * l*cos(q(1))*B) / ((C + l*cos(q(1))*B) * D*C) - (gravity*l*sin(q(1))*B)/D ) - F * (l*cos(q(1))*B) / ((C + l*cos(q(1))*B)*D);
dq(3) = q(4);
dq(4) = ((-b2*q(4) - gravity*l*sin(q(1))*B)) / (C + l*cos(q(1))*B) + F / ((C + l*cos(q(1))*B)*D);

f(1) = q(2);
f(2) = ((-b1*q(2))/D + ((b2*q(4) - gravity*l*sin(q(1))*B) * l*cos(q(1))*B) / ((C + l*cos(q(1))*B) * D*C) - (gravity*l*sin(q(1))*B)/D);
f(3) = q(4);
